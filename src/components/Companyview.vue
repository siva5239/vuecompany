        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-primary"  @click="postCompanyData">
                Save changes
              </button>
            </div>
          </div>
...
export default {
    ...
    methods:{
     AddCompanyData(){
         ...
         axios.get("https://companydata-69c3c-default-rtdb.firebaseio.com/company.json").then((res)=>{this.companiesList=res.data
